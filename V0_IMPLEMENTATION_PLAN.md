# WB V0 Implementation Plan

## الهدف

V0 هي أقل نسخة قابلة للاستخدام لإثبات الدورة الأساسية في WB:
...
القيم الافتراضية للـ seed محلية فقط: `admin@wb.local` وكلمة المرور `ChangeMe123!`. يجب تغييرها قبل أي بيئة مشتركة.
