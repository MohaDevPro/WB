...
WB uses a payment abstraction layer so multiple providers can be integrated without coupling business logic to one gateway.
...
WB should use regulated payment-provider infrastructure for holding funds. Do not implement an unlicensed internal wallet or assume WB may legally custody customer funds.
